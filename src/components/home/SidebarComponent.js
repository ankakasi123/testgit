...
export default function SidebarComponent(props) {
  ...
  // console.log("siderbar",side)
  const price = side.price;
  const result = price ? price.toLocaleString('en-US') : price;



  return (
    <div className="h-full p-3 space-y-2 col-auto bg-gray-600 text-slate-50 dark:bg-gray-900 dark:text-gray-100">
        ...
        <div>
          ...
          <span className="flex items-center space-x-1">
            <p className="text-yellow-600 hover:underline dark:text-gray-400">
              {result} <img src="/img/coin.png" alt="coin" width={15} style={{display:"inline"}} /> <br/> vip: <img src={`/img/${side.vip}.png`} alt={side.vip} width={22} style={{display:"inline"}} />
      ...
      <div className="divide-y divide-gray-700">
        <ul className="pt-2 pb-4 space-y-1 text-sm">
          <li className="dark:bg-gray-800 dark:text-gray-50 hover:bg-gray-500 cursor-pointer">
        ...
        <ul className="pt-4 pb-2 space-y-1 text-sm">
          ...
          {/* <li className="hover:bg-green-300 cursor-pointer">
            <a
              rel="noopener noreferrer"
              href="#"
              className="flex items-center p-2 space-x-3 rounded-md"
