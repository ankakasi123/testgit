...
export default function DangKiVip() {
  return (
    <div className="">
      <div className="">
        {/* vip */}
        <section className=" py-6 sm:py-16 dark:bg-gray-800 dark:text-gray-100">
          <div className="container  p-6 mx-auto space-y-8">
            <div className="space-y-2 text-center">
              <h2 className="text-3xl font-bold">ĐĂNG KÍ GÓI VIP</h2>
              <p className="text-sm dark:text-gray-400">
                Nâng cấp vip để tham gia video kiếm tiền mỗi ngày
              </p>
            </div>
            <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-4 lg:grid-cols-8">
              <article className="text-center rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 flex flex-col w-full h-full dark:bg-gray-900">
                <img
                  alt=""
                  className="cover m-3 dark:bg-gray-500"
                  src="/img/11.png"
                />
                <div className="flex flex-col flex-1">
                  ...
                  >
                    <h2 className="text-2xl text-yellow-500">VIP 1</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 50k
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 20k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                <img
                  alt=""
                  className="cover m-3 dark:bg-gray-500"
                  src="/img/22.png"
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl text-yellow-500">VIP 2</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 120k
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 30k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                <img
                  alt=""
                  className="cover m-3 mb-4 dark:bg-gray-500"
                  src="/img/33.png"
                />
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 3</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 300k
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 80k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-red-200 to-red-300 text-center dark:bg-gray-900">
                <img
                  alt=""
                  className="cover m-3 mb-4 dark:bg-gray-500"
                  src="/img/44.png"
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 4</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 500k
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 150k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 5</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 1TR
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 350k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 6</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 1,5TR
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 600k/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 7</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Giá 2TR2
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>lãi 1tr2/video</div>
                    <div>min rút 100k</div>
                  </div>
                </div>
              </article>
              <article className="flex flex-col rounded-md bg-gradient-to-r from-yellow-50 to-yellow-100 text-center dark:bg-gray-900">
                ...
                <div className="flex flex-col flex-1">
                  <a
                    ...
                    className="text-xs tracking-wider uppercase hover:underline dark:text-violet-400"
                  >
                    <h2 className="text-2xl mt-4 text-yellow-500">VIP 8</h2>
                  </a>
                  <h3 className="flex-1 py-2 text-success text-lg font-semibold leading-snug">
                    Đang nâng cấp
                  </h3>
                  <div className="text-center pb-4 text-blue-500 bold justify-between pt-3 dark:text-gray-400">
                    <div>Trong quá trình</div>
                    <div>nâng cấp ...</div>
                  </div>
                </div>
              </article>
      ...
      {/* atm */}
      <div id="atmvpbank" className="flex w-full" style={{ justifyContent: "space-around" }}>
        <div className="bg-green-500 mt-5 max-w-xs p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-50">
          <img
            src="./img/atm.jpg"
            alt=""
          ...
          <div className="mt-6 mb-2 w-full">
            ...
            <span className="">TRAN ANH TU</span>
            </div>
            <div className="flex flex-row justify-between">
            <span className=" dark:text-violet-400">
              Nâng Hàng
            </span>
            <span className="">VPBANK</span>
            </div>
            <div className="flex flex-row justify-between">
            <span className=" dark:text-violet-400">
              Số Tài Khoản
            </span>
            <span className="">40566666789</span>
            </div>
          </div>
          <p className="dark:text-gray-100 mt-3">
            Chuyển khoản nội dung: <span className="text-red-600">Email & VIP</span>
          </p>
          <p className="dark:text-gray-100">
            <span className="text-red-800 ml-10">xử lý trong vòng 5-10p</span>
          </p>
        </div>
      </div>
      {/* mota */}
